...
public class AtfRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN = "atf_firmendatenexport>";
    private static final String TAG_BTLG_DATEN = "atf_beteiligtenexport>";
