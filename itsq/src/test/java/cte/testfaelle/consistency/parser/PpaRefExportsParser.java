...
public class PpaRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN_FIRMA = "nim-firmendaten>";
    private static final String TAG_STAMM_DATEN_BTLG = "ppa-personen-daten>";
    private static final String TAG_ZUST_DATEN_VC = "zustaendiger-daten-vc>";

    @Override
    public String getClzString(String line) {
        return getStringForXmlTag(line, TAG_ZUST_DATEN_VC, 3);
    }
