...
public class MicRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN_FIRMA = "mic-firmen-daten>";
    private static final String TAG_STAMM_DATEN_BTLG = "mic-beteiligten-daten>";
