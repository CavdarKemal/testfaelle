...
public class CrmRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN = "crm_firmendatenexport>";
    private static final String TAG_BTLG_DATEN = "crm_beteiligtenexport>";
