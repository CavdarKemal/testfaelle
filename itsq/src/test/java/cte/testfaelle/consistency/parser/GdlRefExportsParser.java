...
public class GdlRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "company-identifier>";
    private static final String TAG_STAMM_DATEN = "update-on-capital-share>";
