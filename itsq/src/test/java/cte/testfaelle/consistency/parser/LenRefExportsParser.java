...
public class LenRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN_FIRMA = "len-firmen-daten>";
    private static final String TAG_STAMM_DATEN_BTLG = "len-beteiligten-daten>";
