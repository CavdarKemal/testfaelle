...
public class DnpRefExportsParser extends DefaultRefExportsParser {
    private static final String TAG_CREFONUMMER = "crefonummer>";
    private static final String TAG_STAMM_DATEN = "dnp_firmendatenexport>";
    private static final String TAG_BTLG_DATEN = "dnp_beteiligtenexport>";
